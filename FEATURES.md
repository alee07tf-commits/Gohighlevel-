...
> Actualizado tras **v1.3**. Basado en investigación propia + listado detallado de las ~14 categorías de GHL (2026).
>
...
- Reviews AI y Workflow AI (con Claude, baratos de añadir)
- Conector Google Sheets / webhooks salientes / API pública documentada
- Editor visual de ramas if/else (hoy el UI de ramas es básico)
